...
namespace UTILITY
{
    class utilCommon
    {
        ...
        static public readonly List<string> serialPortBaudBox = new List<string>() {
            "4800",
            "9600",
            "19200",
            "38400",
        ...
        static public readonly List<string> serialPortDataBox = new List<string>(){
            "5",
            "6",
            "7",
            "8"
        };
        static public readonly List<string> serialPortStopBox = new List<string>(){
            "1",
            "1.5",
            "2"
        };
        static public readonly List<string> serialPortParityBox = new List<string>(){
            "NONE",
            "ODD",
            "EVEN"
        };
